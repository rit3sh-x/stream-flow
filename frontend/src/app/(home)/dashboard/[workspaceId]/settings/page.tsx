...
import { DarkMode } from '@/providers/theme/dark-mode'
import { LightMode } from '@/providers/theme/light-mode'
import { SystemMode } from '@/providers/theme/system-mode'
        ...
        <div className="lg:col-span-4 flex lg:flex-row flex-col items-start gap-5">
          <div
            className={cn(
              ...
              theme == 'system' ? 'border-purple-800' : 'border-transparent'
            )}
          ...
          <div
            className={cn(
              'rounded-2xl overflow-hidden cursor-pointer border-4 border-transparent',
              theme == 'light' ? 'border-purple-800' : 'border-transparent'
            )}
          ...
          <div
            className={cn(
              'rounded-2xl overflow-hidden cursor-pointer border-4 border-transparent',
              theme == 'dark' ? 'border-purple-800' : 'border-transparent'
            )}
